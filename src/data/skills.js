...
const ROGUE_SKILLS = [
    ...
    createSkill("r8", "Smoke Bomb", "Rogue", "Debuff", ATTRIBUTES.WIND, 15, 0, TARGETS.ALL_ENEMIES, "Lower Enemy Accuracy.", { type: "DEBUFF", stat: "defense", amount: 0.8 }),
    ...
    createSkill("r13", "Flashbang", "Rogue", "Debuff", ATTRIBUTES.LIGHT, 20, 0, TARGETS.ALL_ENEMIES, "Stun/Blind.", { type: "DEBUFF", stat: "attack", amount: 0.7 }),
