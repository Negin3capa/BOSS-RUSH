...
const HERO_SKILLS = [
    ...
    createSkill("h4", "Courage", "Hero", "Buff", ATTRIBUTES.SPECIAL, 15, 0, TARGETS.ALL_ALLIES, "Raises party Attack.", RARITIES.RARE, { stat: "attack", amount: 1.2 }),
    ...
    createSkill("h8", "Rally", "Hero", "Buff", ATTRIBUTES.SPECIAL, 20, 0, TARGETS.ALL_ALLIES, "Raises party Defense.", RARITIES.RARE, { stat: "defense", amount: 1.2 }),
...
const TANK_SKILLS = [
    ...
    createSkill("t3", "Stone Skin", "Tank", "Buff", ATTRIBUTES.STONE, 15, 0, TARGETS.SELF, "Greatly increases Defense.", RARITIES.RARE, { stat: "defense", amount: 1.5 }),
    createSkill("t4", "Earthquake", "Tank", "Damage", ATTRIBUTES.STONE, 25, 40, TARGETS.ALL_ENEMIES, "Shakes the ground.", RARITIES.EXOTIC),
    createSkill("t5", "Fortify", "Tank", "Buff", ATTRIBUTES.SPECIAL, 20, 0, TARGETS.ALL_ALLIES, "Raises party Defense.", RARITIES.UNCOMMON, { stat: "defense", amount: 1.3 }),
    createSkill("t6", "Shield Wall", "Tank", "Buff", ATTRIBUTES.SPECIAL, 30, 0, TARGETS.ALL_ALLIES, "Drastically raises party Def.", RARITIES.RARE, { stat: "defense", amount: 1.5 }),
    ...
    createSkill("t15", "Intimidate", "Tank", "Debuff", ATTRIBUTES.SPECIAL, 15, 0, TARGETS.ALL_ENEMIES, "Lowers enemy Attack.", RARITIES.UNCOMMON, { stat: "attack", amount: 0.8 }),
...
const MAGE_SKILLS = [
    ...
    createSkill("m9", "Focus", "Mage", "Buff", ATTRIBUTES.SPECIAL, 15, 0, TARGETS.SELF, "Greatly raises Special Attack.", RARITIES.RARE, { stat: "specialAttack", amount: 1.5 }),
